...
int main() {
    ...
    std::cout << sizeof(S::sh2) << std::endl;
    std::cout << sizeof(S::str1) << std::endl;
    std::cout << sizeof(S::dbl) << std::endl;
    std::cout << offsetof(S, l) << std::endl;
    std::cout << offsetof(S, l) - (offsetof(S, ch) + sizeof(S::ch)) << std::endl;
    std::cout << offsetof(S, f) - (offsetof(S, sh2) + sizeof(S::sh2)) << std::endl;
    std::cout << offsetof(S, str2) << std::endl;
    std::cout << sizeof(S) - (offsetof(S, str2) + sizeof(S::str2)) << std::endl;
